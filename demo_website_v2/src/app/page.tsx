    ...
    <div className="min-h-screen gradient-hero relative overflow-hidden">
      ...
      <section className="relative z-10 container py-14">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="card p-6">
            <h3 className="text-lg font-semibold text-cyan-300 mb-2">Tech</h3>
            <ul className="text-gray-300 list-disc list-inside space-y-1">
              <li>Next.js + Tailwind UI</li>
              <li>Netlify Functions: tool proxy and UI feed</li>
              <li>FastAPI backend: `/tools/immigration_news`, `/tools/forms_finder`</li>
              <li>UI events: `/ui/event`, `/ui/feed`</li>
            </ul>
          </div>
          <div className="card p-6">
            <h3 className="text-lg font-semibold text-cyan-300 mb-2">Try it</h3>
            <p className="text-gray-300">Open the demo and ask about a policy topic or a specific form like “I-485”.</p>
            <div className="mt-4">
              <Link href="/immigration" className="px-6 py-3 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold hover:from-blue-600 hover:to-cyan-600 transition-all">Open Immigration Demo</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="architecture" className="relative z-10 container py-14">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="card p-6">
            ...
            <ul className="text-gray-300 list-disc list-inside space-y-1">
              <li>Next.js + Tailwind UI at <code>/immigration</code></li>
              <li>ElevenLabs Agent real‑time voice</li>
              <li>Netlify Functions: tool proxies + UI feed</li>
              <li>FastAPI backend: immigration_news, forms_finder, UI events</li>
            </ul>
          </div>
          <div className="card p-6">
